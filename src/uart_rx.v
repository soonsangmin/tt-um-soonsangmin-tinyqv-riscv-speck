...
module uart_rx #(parameter 
    BIT_RATE     = 115200,       // Input bit rate of the UART line, bits / sec
    CLK_HZ       = 12_000_000, // Clock frequency in hertz.
...
// Thay thế function bằng biến reg và khối always tổ hợp
